...
<?php
	...
	$rezultat = mysqli_query($konekcija, "SELECT * FROM $naziv_tabele WHERE opis = '' ; ");
...
<?php
	...
	<div class='odeljak_opis'>
		<p>". $brojac . ") <a target='_blank' href='../izvor.php?br=$id&vrsta=$vrsta_materijala'><i>" . $id . " </i> " . $opis . " </a> <input value=$oblast class='oblast' ondblclick='promeniOblast(this, $id, $vrsta_materijala)'><span></span></p>\n";
